...
```bash
mvn -B package -DskipTests      # target/it-provisioning-agent-1.7.8-mule-application.jar

yc deploy file <org> Sandbox <business-group-id> it-provisioning-agent 1.7.8 \
  target/it-provisioning-agent-1.7.8-mule-application.jar target=ch2:<cluster> \
